...
async function startToEndScenario() {
    ...
    let artwork = await mintArtwork(1000, 10, 100, "Mona Lisa", "Leonardo da Vinci", "1685548680595", "Choconta painting", "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg/800px-Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg");
    if (!artwork)
    ...
    let voteRequest = await createVoteRequest(artwork, "Request to sell artwork to Bob");
    if (!voteRequest)
...
startToEndScenario();
//# sourceMappingURL=start_to_end.js.map