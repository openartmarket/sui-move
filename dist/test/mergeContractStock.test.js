...
import { ADMIN_CAP_ID, ADMIN_PHRASE, getClient, getObject, mintContractOptions, PACKAGE_ID, USER1_ADDRESS, USER1_PHRASE, } from "./test-helpers";
describe("mergeContractStock", () => {
    ...
    it("should merge contract stocks", async () => {
        const { contractStockIds: [toContractStockId], } = await mintContractStock(executor, [
            {
        ...
        const { contractStockIds: [fromContractStockId], } = await mintContractStock(executor, [
            {
                adminCapId: ADMIN_CAP_ID,
                contractId,
                receiverAddress: USER1_ADDRESS,
...
//# sourceMappingURL=mergeContractStock.test.js.map