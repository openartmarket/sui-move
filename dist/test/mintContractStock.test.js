...
import { ADMIN_ADDRESS, ADMIN_CAP_ID, adminExecutor, getQuantity, makeWallet, mintContractOptions, } from "./test-helpers";
describe("mintContractStock", () => {
    ...
    it("should not issue new shares, when asking for too much", async () => {
        await assert.rejects(mintContractStock(adminExecutor, [
            {
                adminCapId: ADMIN_CAP_ID,
                contractId,
                quantity: 501,
