...
import { ADMIN_ADDRESS, ADMIN_CAP_ID, ADMIN_PHRASE, getClient, mintContractOptions, PACKAGE_ID, USER1_ADDRESS, USER2_ADDRESS, USER3_ADDRESS, } from "./test-helpers";
describe("mintContractStock", () => {
    ...
    it("should not issue new shares, when asking for too much", async () => {
        await assert.rejects(mintContractStock(executor, [
            {
                adminCapId: ADMIN_CAP_ID,
                contractId,
                quantity: 501,
...
//# sourceMappingURL=mintContractStock.test.js.map