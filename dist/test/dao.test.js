...
import { ADMIN_ADDRESS, ADMIN_CAP_ID, ADMIN_PHRASE, getClient, mintContractOptions, PACKAGE_ID, USER1_ADDRESS, USER1_PHRASE, USER2_ADDRESS, USER3_PHRASE, } from "./test-helpers";
describe("DAO Voting structure", () => {
    ...
    it("cannot double vote as a shareholder", async () => {
        ...
        await assert.rejects(vote(voterExecutor, {
            contractId,
            motionId,
            choice: true,
        }));
