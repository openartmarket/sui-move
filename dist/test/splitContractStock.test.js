...
describe("splitContractStock", () => {
    ...
    it("should split an contract stock", async () => {
        const { contractStockIds: [contractStockId], } = await mintContractStock(adminExecutor, [
            {
    ...
    it("should split a split stock", async () => {
        ...
        const { splitContractStockId: splitAgainContractStockId } = await splitContractStock(wallet.executor, {
